...
async function update(newYear) {
    if(newYear ==undefined){
      ...
      d3.csv("data/vigilancia_2015.csv").then(function(sample) {
      ...
      d3.csv("data/vigilancia_2016.csv").then(function(sample) {
      ...
      d3.csv("data/vigilancia_2017.csv").then(function(sample) {
      ...
      d3.csv("data/vigilancia_2018.csv").then(function(sample) {
